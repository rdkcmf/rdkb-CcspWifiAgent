...
int json_to_blob(const char *json, msgpack_sbuffer *sbuf)
{
    msgpack_packer pk;
    ...
    if (msgpack_pack_jsonstr(&pk, json) < 0) {
...
int blob_to_json(msgpack_sbuffer *sbuf, char *jsonparsed, size_t jsonstrlen)
{
    msgpack_zone z;
    msgpack_object obj;
